...
public interface IRadioResponse extends IBase {
    ...
    public static final class Proxy implements IRadioResponse {
        ...
        @Override // android.hardware.radio.V1_0.IRadioResponse, android.hidl.base.V1_0.IBase
        ...
        public void getImsRegistrationStateResponse(RadioResponseInfo info, boolean isRegistered, int ratFamily) throws RemoteException {
            ...
            HwParcel _hidl_reply = new HwParcel();
            try {
                this.mRemote.transact((int) LastCallFailCause.RECOVERY_ON_TIMER_EXPIRED, _hidl_request, _hidl_reply, 1);
                _hidl_request.releaseTemporaryStorage();
            } finally {
                _hidl_reply.release();
            }
        ...
        public void setUiccSubscriptionResponse(RadioResponseInfo info) throws RemoteException {
            ...
            HwParcel _hidl_reply = new HwParcel();
            try {
                this.mRemote.transact((int) DataCallFailCause.APN_TYPE_CONFLICT, _hidl_request, _hidl_reply, 1);
                _hidl_request.releaseTemporaryStorage();
            } finally {
                _hidl_reply.release();
            }
        ...
        public void setDataAllowedResponse(RadioResponseInfo info) throws RemoteException {
            ...
            HwParcel _hidl_reply = new HwParcel();
            try {
                this.mRemote.transact((int) DataCallFailCause.INVALID_PCSCF_ADDR, _hidl_request, _hidl_reply, 1);
                _hidl_request.releaseTemporaryStorage();
            } finally {
                _hidl_reply.release();
            }
        ...
        public void getHardwareConfigResponse(RadioResponseInfo info, ArrayList<HardwareConfig> config) throws RemoteException {
            ...
            HwParcel _hidl_reply = new HwParcel();
            try {
                this.mRemote.transact((int) DataCallFailCause.INTERNAL_CALL_PREEMPT_BY_HIGH_PRIO_APN, _hidl_request, _hidl_reply, 1);
                _hidl_request.releaseTemporaryStorage();
            } finally {
                _hidl_reply.release();
            }
        ...
        public void requestIccSimAuthenticationResponse(RadioResponseInfo info, IccIoResult result) throws RemoteException {
            ...
            HwParcel _hidl_reply = new HwParcel();
            try {
                this.mRemote.transact((int) DataCallFailCause.EMM_ACCESS_BARRED, _hidl_request, _hidl_reply, 1);
                _hidl_request.releaseTemporaryStorage();
            } finally {
                _hidl_reply.release();
            }
        ...
        public void setDataProfileResponse(RadioResponseInfo info) throws RemoteException {
            ...
            HwParcel _hidl_reply = new HwParcel();
            try {
                this.mRemote.transact((int) DataCallFailCause.EMERGENCY_IFACE_ONLY, _hidl_request, _hidl_reply, 1);
                _hidl_request.releaseTemporaryStorage();
            } finally {
                _hidl_reply.release();
            }
        ...
        public void requestShutdownResponse(RadioResponseInfo info) throws RemoteException {
            ...
            HwParcel _hidl_reply = new HwParcel();
            try {
                this.mRemote.transact((int) DataCallFailCause.IFACE_MISMATCH, _hidl_request, _hidl_reply, 1);
                _hidl_request.releaseTemporaryStorage();
            } finally {
                _hidl_reply.release();
            }
        ...
        public void getRadioCapabilityResponse(RadioResponseInfo info, RadioCapability rc) throws RemoteException {
            ...
            HwParcel _hidl_reply = new HwParcel();
            try {
                this.mRemote.transact((int) DataCallFailCause.COMPANION_IFACE_IN_USE, _hidl_request, _hidl_reply, 1);
                _hidl_request.releaseTemporaryStorage();
            } finally {
                _hidl_reply.release();
            }
        ...
        public void setRadioCapabilityResponse(RadioResponseInfo info, RadioCapability rc) throws RemoteException {
            ...
            HwParcel _hidl_reply = new HwParcel();
            try {
                this.mRemote.transact((int) DataCallFailCause.IP_ADDRESS_MISMATCH, _hidl_request, _hidl_reply, 1);
                _hidl_request.releaseTemporaryStorage();
            } finally {
                _hidl_reply.release();
            }
        ...
        public void startLceServiceResponse(RadioResponseInfo info, LceStatusInfo statusInfo) throws RemoteException {
            ...
            HwParcel _hidl_reply = new HwParcel();
            try {
                this.mRemote.transact((int) DataCallFailCause.IFACE_AND_POL_FAMILY_MISMATCH, _hidl_request, _hidl_reply, 1);
                _hidl_request.releaseTemporaryStorage();
            } finally {
                _hidl_reply.release();
            }
        ...
        public void stopLceServiceResponse(RadioResponseInfo info, LceStatusInfo statusInfo) throws RemoteException {
            ...
            HwParcel _hidl_reply = new HwParcel();
            try {
                this.mRemote.transact((int) DataCallFailCause.EMM_ACCESS_BARRED_INFINITE_RETRY, _hidl_request, _hidl_reply, 1);
                _hidl_request.releaseTemporaryStorage();
            } finally {
                _hidl_reply.release();
            }
        ...
        public void pullLceDataResponse(RadioResponseInfo info, LceDataInfo lceInfo) throws RemoteException {
            ...
            HwParcel _hidl_reply = new HwParcel();
            try {
                this.mRemote.transact((int) DataCallFailCause.AUTH_FAILURE_ON_EMERGENCY_CALL, _hidl_request, _hidl_reply, 1);
                _hidl_request.releaseTemporaryStorage();
            } finally {
                _hidl_reply.release();
            }
        ...
        public void setIndicationFilterResponse(RadioResponseInfo info) throws RemoteException {
            ...
            HwParcel _hidl_reply = new HwParcel();
            try {
                this.mRemote.transact((int) LastCallFailCause.INTERWORKING_UNSPECIFIED, _hidl_request, _hidl_reply, 1);
                _hidl_request.releaseTemporaryStorage();
            } finally {
                _hidl_reply.release();
            }
    ...
    public static abstract class Stub extends HwBinder implements IRadioResponse {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{29, 74, 87, 118, 97, 76, 8, -75, -41, -108, -91, -20, 90, -80, 70, -105, 38, 12, -67, 75, 52, 65, -43, -109, 92, -43, 62, -25, 29, 25, -38, 2}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
