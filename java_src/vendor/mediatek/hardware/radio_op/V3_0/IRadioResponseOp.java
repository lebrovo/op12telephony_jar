...
public interface IRadioResponseOp extends IBase {
    public static final String kInterfaceName = "vendor.mediatek.hardware.radio_op@3.0::IRadioResponseOp";
    ...
    public static final class Proxy implements IRadioResponseOp {
        ...
        @Override // vendor.mediatek.hardware.radio_op.V3_0.IRadioResponseOp, android.hidl.base.V1_0.IBase
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of vendor.mediatek.hardware.radio_op@3.0::IRadioResponseOp]@Proxy";
            }
        }
        ...
        @Override // vendor.mediatek.hardware.radio_op.V3_0.IRadioResponseOp
    ...
    public static abstract class Stub extends HwBinder implements IRadioResponseOp {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(IRadioResponseOp.kInterfaceName, IBase.kInterfaceName));
        }
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{-66, 26, 46, -94, -35, 5, -7, -50, -79, -99, 91, -49, 39, -44, -96, 54, 74, -106, -127, -108, -27, 88, -54, 13, 79, -87, 84, -105, 58, 79, 122, 11}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
